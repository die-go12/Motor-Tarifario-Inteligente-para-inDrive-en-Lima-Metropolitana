...
- Integración Google Maps (distancia y tiempo)
- Integración OSINERGMIN (combustible)
- Integración API de tráfico
- Algoritmo de cálculo de rango
...
**Objetivo:** Mostrar información distinta según rol.

Tareas:
- Vista pasajero (solo máximo)
- Vista conductor (solo mínimo)
- Vista administrador (rango completo)
...
**Objetivo:** Permitir negociación dentro de límites permitidos.
...
**Objetivo:** Iniciar el viaje con aceptación de ambas partes.
...
- Disponible en entorno de desarrollo
...
- Aceptación bilateral del viaje
- Inicio del viaje en estado “En curso”
