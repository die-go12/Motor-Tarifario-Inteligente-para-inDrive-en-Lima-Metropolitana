...
| ID | Título | Actor principal | Prioridad | CAR relacionados |
| :--- | :--- | :--- | :--- | :--- |
| US-001 | Solicitud de viaje con cálculo de rango | Pasajero | 🔴 Alta | CAR-001, CAR-009, CAR-010 |
| US-002 | Visualización asimétrica del precio | Pasajero / Conductor | 🔴 Alta | CAR-002 |
| US-003 | Negociación acotada dentro del rango | Pasajero / Conductor | 🔴 Alta | CAR-003, CAR-007 |
| US-004 | Aceptación bilateral e inicio de viaje | Pasajero / Conductor | 🔴 Alta | CAR-002, CAR-007 |
| US-005 | Recálculo post-viaje con GPS real | Sistema | 🔴 Alta | CAR-004, CAR-009 |
| US-006 | Aplicación de la regla de pago invariante | Sistema | 🔴 Alta | CAR-004, CAR-005 |
| US-007 | Configuración de parámetros desde panel admin | Administrador | 🟠 Media | CAR-006, CAR-007 |
| US-008 | Visualización de reportes y métricas | Administrador | 🟠 Media | CAR-008 |
